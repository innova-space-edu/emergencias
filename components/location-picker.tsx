...
export default function LocationPicker({value,onChange}:{value:Coordinates|null;onChange:(v:Coordinates)=>void}){
 const host=useRef<HTMLDivElement|null>(null),mapRef=useRef<MapLibreMap|null>(null),markerRef=useRef<Marker|null>(null);const [fallback,setFallback]=useState(false);
